...
<div>
    <div class="message">
        ...
        <div v-if="data.content !== undefined && data.content !== null && data.content.trim() !== ''" class="content">{{data.content}}</div>
        <!-- TODO: Attachments -->
            ...
            <div class="embed" v-bind:style="{borderColor: '#' + embed.color.toString(16)}">
                <div class="embed-body">
                    <div class="author" v-if="embed.author && embed.author.name">
                        <img v-if="embed.author.icon_url" v-bind:src="embed.author.icon_url" alt="Icon" class="author-icon">
                        <a v-if="embed.author.url" v-bind:href="embed.author.url" class="author-name" target="_blank">{{ embed.author.name }}</a>
                    ...
                    <div class="fields" v-if="embed.fields">
                        <!-- TODO: Field inline -->
                        <div v-for="(field, i) in embed.fields" v-bind:key="i" class="field" style="grid-column: 1 / 13;">
                    ...
                    <img v-if="embed.image && embed.image.url" v-bind:src="embed.image.url" alt="image" class="image">
                    <div class="footer" v-if="embed.timestamp || (embed.footer && (embed.footer.text || embed.footer.icon_url))">
                        <img v-if="embed.footer.icon_url" v-bind:src="embed.footer.icon_url" alt="Icon" class="footer-icon">
