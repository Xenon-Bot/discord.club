...
<div class="quick" v-on:paste="addFileFromClipboard">
    <div class="row">
        ...
        <h4 class="ml-2 mb-3">Webhook</h4>
                ...
                <div class="card-body mb-0">
                    <div class="form-row mb-2">
                        <div class="col-12 mb-4">
                            ...
                            <input v-model.trim.lazy="webhookUrl" type="url" class="form-control" placeholder="https://discord.com/api/webhooks/423157583646294017/nsFEJfuNKVBRcKcgj0JX3TygdvhX-ItEJhrWVWadw7shUXXuIRwsJHUS_XbDDSA_ILKN">
                        </div>
                        <div class="col-12 mb-4">
                            ...
                            <input v-model.trim.lazy="messageUrl" type="text" class="form-control" placeholder="https://discord.com/channels/410488579140354049/633228954064650250/781981855808487477">
                        </div>
                    </div>
                    <button class="btn btn-outline-primary float-right" v-on:click="sendMessage" v-bind:class="{disabled: !this.webhookUrl}">
                ...
                <div class="card-body">
                    <div class="form-row mb-2">
                            <div class="col-12 col-lg-6 mb-4">
                                ...
                                <input v-model.trim="webhookUsername" type="text" class="form-control" placeholder="Captain Hook" maxlength="80">
                            </div>
                            <div class="col-12 col-lg-6">
                                ...
                                <input v-model.trim="webhookAvatarUrl" type="url" class="form-control" placeholder="https://i.imgur.com/yed5Zfk.png">
                            </div>
                        <div class="col-12 mb-4">
                            <label>Content</label>
                            ...
                            <textarea v-model="content" rows="5" class="form-control" placeholder="I like webhooks" maxlength="2000"></textarea>
                        </div>
                        <div class="col-12">
                            <label>Files</label>
                            <span class="text-muted ml-2 char-counter">Max. 8 MB</span>
                            <div class="row mb-2 m-0">
                                <span v-for="(file, i) in files" v-bind:key="i" class="px-2 py-1 m-1 bg-dark col-auto rounded">
                                    <label class="mr-2 d-inline">{{file.name}}</label>
                                    <span class="c-pointer d-line" v-on:click="deleteFile(i)"><i class="fas fa-minus"></i></span>
                                </span>
                            </div>
                            <input type="file" class="btn btn-sm btn-outline-light mr-2" v-on:change="addFileFromInput">
            ...
            <h4 class="ml-2 mb-3">Embeds <span class="text-muted ml-2 char-counter h6">{{ embeds.length }} / 10</span></h4>
            <div class="mb-5">
                <div v-for="(embed, e) in embeds" v-bind:key="e" class="card tex-light mb-3 bg-darker" v-bind:style="{borderLeft: '5px solid' + embed.color}">
                    <div class="card-body">
                        <div class="float-right" style="font-size: 1.1rem">
                            <span class="mr-3 c-pointer" v-if="e != 0" v-on:click="moveEmbedUp(e)"><i class="fas fa-chevron-up"></i></span>
                            <span class="mr-3 c-pointer" v-if="e != embeds.length - 1" v-on:click="moveEmbedDown(e)"><i class="fas fa-chevron-down"></i></span>
                            <span class="mr-3 c-pointer" v-if="embeds.length < 10" v-on:click="cloneEmbed(e)"><i class="far fa-copy"></i></span>
                            <span class="mr-3 c-pointer" v-on:click="deleteEmbed(e)"><i class="fas fa-minus"></i></span>
                        </div>
                        <h5 data-toggle="collapse" v-bind:data-target="'#embed' + e" role="button" class="overflow-auto text-nowrap">
                            Embed {{ e + 1 }}
                        ...
                        <div class="collapse mt-3" v-bind:id="'embed' + e">
                            <div class="form-row">
                                <div class="col-12 mb-4">
                                    ...
                                    <input v-model.trim="embed.authorName" type="text" class="form-control" placeholder="Doctor Who" maxlength="256">
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    <label>Author URL</label>
                                    <input v-model.trim="embed.authorUrl" type="url" class="form-control" placeholder="https://discord.club">
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    ...
                                    <input v-model.trim="embed.authorIconUrl" type="url" class="form-control" placeholder="https://i.imgur.com/yed5Zfk.png">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-12 mb-4">
                                    ...
                                    <input v-model.trim="embed.title" type="text" class="form-control" placeholder="My Embed" maxlength="256">
                                </div>
                                <div class="col-12 mb-4">
                                    <label>Description</label>
                                    <span class="text-muted ml-2 char-counter">{{ embed.description ? embed.description.length : 0 }} / 2048</span>
                                    <textarea v-model="embed.description" class="form-control" placeholder="My first template" rows="5" maxlength="2048"></textarea>
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    <label>URL</label>
                                    <input v-model.trim="embed.url" type="url" class="form-control" placeholder="https://discord.club">
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    <label>Color</label>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-lg-6 mb-4">
                                    ...
                                    <input v-model.trim="embed.imageUrl" type="url" class="form-control" placeholder="https://i.imgur.com/yed5Zfk.png">
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    <label>Thumbnail URL
                                        <span class="ml-1 hover-tooltip" title="yeet">
                                    ...
                                    <input v-model.trim="embed.thumbnailUrl" type="url" class="form-control" placeholder="https://i.imgur.com/yed5Zfk.png">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-12 mb-4">
                                    ...
                                    <input v-model.trim="embed.footerText" type="text" class="form-control" placeholder="this is the end" maxlength="256">
                                </div>
                                <div class="col-12 col-lg-6 mb-4">
                                    <label>Timestamp</label>
                                    <div class="form-row">
                                        <div class="col">
                                            <datetime v-model.trim="embed.timestamp" type="datetime" input-class="form-control"></datetime>
                                        </div>
                                        <div class="col-auto">
                                            <button class="btn btn-outline-light" v-on:click="embed.timestamp = null">
                                ...
                                <div class="col-12 col-lg-6 mb-4">
                                    ...
                                    <input v-model.trim="embed.footerIconUrl" type="url" class="form-control" placeholder="https://i.imgur.com/yed5Zfk.png">
                                </div>
                            </div>
                            <h5>Fields <span class="text-muted ml-2 char-counter">{{ embed.fields ? embed.fields.length : 0 }} / 10</span></h5>
                            <div v-for="(field, f) in embed.fields" v-bind:key="f">
                                ...
                                <span class="c-pointer float-right" v-on:click="deleteField(e, f)"><i class="fas fa-minus"></i></span>
                                <div class="form-row mb-3">
                                    <div class="col-8 col-sm-10 mb-3">
                                        <input v-model.trim="field.name" type="text" class="form-control" placeholder="Name" maxlength="256">
                                    </div>
                                    <div class="col-4 col-sm-2 mb-3">
                                        <div class="form-check pt-2">
                                            <input v-model.trim="field.inline" type="checkbox" class="form-check-input">
                                            <label class="form-check-label">Inline</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <textarea v-model.trim="field.value" rows="2" class="form-control" placeholder="Value" maxlength="1024"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn btn-sm btn-outline-light" v-on:click="addField(e)" v-bind:class="{disabled: embed.fields ? embed.fields.length >= 10 : false}">
                ...
                <div class="btn btn-sm btn-outline-primary" v-on:click="addEmbed" v-bind:class="{disabled: embeds.length >= 10}">
                    <i class="fas fa-plus"></i>
                </div>
            </div>
        </div>
